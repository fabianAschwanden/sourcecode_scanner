...
| DR-22a | S | Kreditkartentreffer MÜSSEN zusätzlich zum Luhn-Check einen **Emittenten-Schema-Quercheck** (IIN/BIN-Präfix **und** schemakonforme Länge) bestehen: Visa (4, Länge 13/16/19), Mastercard (51–55 oder 2221–2720, Länge 16), Amex (34/37, Länge 15), Discover (6011/65/644–649/622126–622925, Länge 16/19), Diners (300–305/3095/36/38–39, Länge 14–19), JCB (3528–3589, Länge 16–19), UnionPay (62, Länge 16–19), Maestro (50/56–69, Länge 12–19). Luhn-gültige Zahlen ohne passendes Kartenpräfix (lange IDs/Timestamps/Tracking-Nummern) schlagen NICHT an (FP-Reduktion). |
